...
document.getElementById("register").addEventListener("click", function(event) {
    const username = document.getElementById("usernameqmk");
    const email = document.getElementById("emailqmk");
    const errorMessage = document.getElementById("register-error-message");
    const popup = document.getElementById("register-error-popup");
    ...
    if (!username.value && !email.value) {
        valid = false;
        errorMessage.innerText = "Lỗi: Vui lòng nhập tên đăng nhập hoặc địa chỉ email.";
